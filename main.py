...
if __name__ == '__main__':
    ...
    parser.add_argument('--database_path', type=str, default='LA_subset', help='change this to user\'s full directory address of LA database')
    parser.add_argument('--protocols_path', type=str, default='LA_subset/ASVspoof2019_LA_cm_protocols', help='Change with path to user\'s LA database protocols directory address')
    ...
    sample_size=100  # 🔥 This speeds it up drastically
)
    ...
    transform=transforms,
    feature_name=args.features,
    sample_size=100  # ← Only use 100 examples for training
)
